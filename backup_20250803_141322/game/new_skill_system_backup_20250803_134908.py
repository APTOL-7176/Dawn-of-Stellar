        ...
        return {
            ...
            "성기사": [
                ...
                {"name": "치유의빛", "type": SkillType.HEAL, "target": TargetType.SINGLE_ALLY,
                 "mp_cost": 6, "heal_power": 2.2, "element": ElementType.LIGHT,
            ...
            "정령술사": [
                ...
                {"name": "물정령치유", "type": SkillType.HEAL, "target": TargetType.SINGLE_ALLY,
                 "mp_cost": 6, "heal_power": 1.9, "element": ElementType.WATER,
            ...
            "시간술사": [
                ...
                {"name": "시간왜곡", "type": SkillType.SPECIAL, "target": TargetType.BATTLEFIELD,
                 "mp_cost": 8, "cooldown": 3, "description": "[시간][기록] 현재 전장의 모든 상태를 시간에 기록. 시간되돌리기의 기준점 생성",
                ...
                {"name": "시간되돌리기", "type": SkillType.SPECIAL, "target": TargetType.ANY_SINGLE,
                 ...
                 "organic_effects": {"시간_조작": 0.5, "마법_지식": 0.35, "정밀함": 0.25}},
            ...
            "차원술사": [
                ...
                {"name": "차원장막", "type": SkillType.BUFF, "target": TargetType.SELF,
                 "mp_cost": 4, "description": "[차원][회피] 1~2회 공격을 확정으로 회피하는 장막 생성",
                 "status_effects": [{"type": StatusType.ABSOLUTE_EVASION, "duration": 1, "intensity": 2.0}],
                ...
                {"name": "잔상분신", "type": SkillType.BUFF, "target": TargetType.SELF,
                 "mp_cost": 5, "description": "[차원][분신] 차원 잔상으로 회피율 30% 증가",
