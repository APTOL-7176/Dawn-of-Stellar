...
class IntegratedBeginnerGuide:
        ...
        return {
            "게임_소개": {
                ...
                "content": [
                    ...
                    "  2. 무한 차원 공간을 탐험하며 적을 물리치고 성장하세요",
            ...
            "차원공간_탐험_기초": {
                "title": "🗺️ 차원 공간 탐험 완전 마스터 - 생존의 기술",
                "description": "무한 차원 공간을 탐험하는 모든 것",
                "content": [
                    "🏰 Dawn Of Stellar의 차원 공간 시스템:",
                    "  → 절차적 생성으로 매번 다른 차원 공간",
                    "  → 무한 층수로 끝없는 도전",
                    "  → 층마다 난이도와 보상 증가",
                    "",
                    "🚶‍♂️ 기본 이동과 조작:",
    ...
    def show_quick_start(self):
        """빠른 시작 가이드"""
        quick_sections = ["게임_소개", "Brave_쉽게_이해하기", "첫_전투_가이드", "차원공간_탐험_기초"]
