    ...
    def _create_design_options(self) -> Dict:
        ...
        return {
            ...
            "암살자": {
                "방향1": {
                    "이름": "💀 완벽 암살자",
                    "컨셉": "그림자를 생성하고 소모하여 압도적 화력을 발휘하는 킬러",
                    "특징": ["그림자 생성", "그림자 소모", "화력 증폭"],
                    "키워드": ["그림자", "증폭", "강화", "처형"],
                    "핵심특성": ["그림자_시스템", "화력_증폭", "처형_특화"]
                },
                "방향2": {
                    "이름": "☠️ 독살 전문가",
                    ...
                    "키워드": ["독살", "중독", "지속", "독성"],
                    "핵심특성": ["독날_무기", "그림자_연막", "치명타_특화"]
                },
                "방향3": {
                    "이름": "👤 그림자 조작자",
                    "컨셉": "그림자를 전략적으로 관리하며 전투를 지배하는 술사",
                    "특징": ["그림자 관리", "전략적 운용", "단계별 강화"],
                    "키워드": ["관리", "전략", "단계", "강화"],
                    "핵심특성": ["그림자_관리", "전략_운용", "단계_강화"]
                }
            },
