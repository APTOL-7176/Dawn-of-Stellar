...
class AutoPartyBuilder:
    ...
    def _get_trait_priorities(self, class_name: str) -> Dict[str, int]:
        """직업별 특성 우선순위 (모든 27개 직업)"""
        priorities = {
            "전사": {"불굴의 의지": 10, "방어 숙련": 9, "피의 갈증": 8, "전투 광기": 7, "위협적 존재": 6},
            "아크메이지": {"마력 집중": 10, "마나 순환": 9, "원소 지배": 8, "마법 폭주": 7, "마법 연구자": 6},
            "궁수": {"정밀 사격": 10, "민첩한 몸놀림": 9, "원거리 숙련": 8, "바람의 가호": 7, "사냥꾼의 직감": 6},
            "도적": {"빠른 손놀림": 10, "그림자 은신": 9, "독 숙련": 8, "치명적 급소": 7, "도적의 직감": 6},
            "성기사": {"치유의 빛": 10, "신성한 가호": 9, "축복받은 무기": 8, "수호의 맹세": 7, "정의의 분노": 6},
            "암흑기사": {"생명 흡수": 10, "어둠의 계약": 9, "불사의 의지": 8, "어둠 조작": 7, "공포 오라": 6},
            "몽크": {"내공 순환": 10, "연타 숙련": 9, "정신 수양": 8, "참선의 깨달음": 7, "기절 공격": 6},
            "바드": {"영감 부여": 10, "다중 주문": 9, "재생의 노래": 8, "마법 저항": 7, "카리스마": 6},
            "네크로맨서": {"언데드 소환": 10, "영혼 조작": 9, "생명력 흡수": 8, "어둠 친화": 7, "공포 유발": 6},
            "용기사": {"용의 분노": 10, "비늘 방어": 9, "생명력 흡수": 8, "용의 숨결": 7, "고대의 지혜": 6},
            "검성": {"무한 검기": 10, "카타나 숙련": 9, "검기 방출": 8, "검의 춤": 7, "무사도": 6},
            "정령술사": {"정령 소환": 10, "원소 지배": 9, "자연과의 대화": 8, "정령 친화": 7, "마나 효율": 6},
            "암살자": {"그림자 이동": 10, "독 마스터": 9, "일격필살": 8, "은신 숙련": 7, "치명타 특화": 6},
            "기계공학자": {"기계 소환": 10, "발명가": 9, "기계 친화": 8, "수리 기술": 7, "창의성": 6},
            "무당": {"영적 보호": 10, "자연 치유": 9, "영혼 시야": 8, "악령 퇴치": 7, "신령 소통": 6},
            "해적": {"해적 코드": 10, "선상 전투": 9, "보물 탐지": 8, "해상 경험": 7, "운명의 바람": 6},
            "사무라이": {"카타나 숙련": 10, "명예의 길": 9, "집중력": 8, "일격필살": 7, "무사도": 6},
            "드루이드": {"자연의 가호": 10, "야생 동조": 9, "자연 치유": 8, "동물 친화": 7, "식물 성장": 6},
            "철학자": {"깊은 사고": 10, "지혜의 힘": 9, "논리적 분석": 8, "정신 집중": 7, "학자의 직감": 6},
            "시간술사": {"시간 조작": 10, "인과 조작": 9, "시간 정지": 8, "예지력": 7, "시공간 이해": 6},
            "연금술사": {"물질 변환": 10, "연금술 숙련": 9, "포션 제작": 8, "원소 이해": 7, "실험 정신": 6},
            "검투사": {"검투 기술": 10, "관중 어필": 9, "전투 본능": 8, "생존 의지": 7, "명성": 6},
            "기사": {"기사도": 10, "충성심": 9, "중무장": 8, "기마술": 7, "귀족의 품격": 6},
            "신관": {"신성한 힘": 10, "축복": 9, "치유 마법": 8, "정화": 7, "신앙": 6},
            "마검사": {"마검 조화": 10, "이중 숙련": 9, "마법 검술": 8, "원소 부여": 7, "균형 감각": 6},
            "차원술사": {"차원 이동": 10, "공간 왜곡": 9, "차원 균열": 8, "시공간 이해": 7, "무한 지식": 6},
            "광전사": {"광기 상태": 10, "분노": 9, "무모한 돌진": 8, "고통 무시": 7, "전투 흥분": 6}
        }
