...
cls
echo.
echo     echo     Checking instal    echo     Model Information:
    echo       Name: EEVE-Korean Instruct 10.8B (bnksys build)  
    echo       Full Name: bnksys/yanolja-eeve-korean-instruct-10.8b
    echo       Size: About 6.2GB
    echo       Features: Korean-specialized, natural conversation
    echo       Developer: bnksys (Ollama community)
    echo.
    ...
    if /i "%install_choice%"=="y" (
        ...
        ollama run bnksys/yanolja-eeve-korean-instruct-10.8b "설치가 완료되었습니다!"llama list | findstr "bnksys"
if %errorlevel%==0 (
    ...
    if /i "%test_choice%"=="y" (
        ...
        ollama run bnksys/yanolja-eeve-korean-instruct-10.8b "안녕하세요! 저는 Dawn of Stellar의 로바트입니다!"
    )====================================================
...
echo     ========================================
echo       [5] Korean AI Model Setup/Check
