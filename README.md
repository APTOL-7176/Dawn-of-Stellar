...
[� 자동 설치](#-원클릭-자동-설치) • [🎮 플레이 가이드](#-게임-시스템) • [📋 v2.1.0 주요 변경사항](#-v210-주요-변경사항) • [🤝 기여하기](#-기여하기)
...
Dawn Of Stellar v2.1.0은 클래식한 로그라이크의 재미와 현대적인 전투 시스템, 그리고 **메타 진행 시스템**을 결합한 혁신적인 ASCII RPG입니다. 
...
- **향상된 ATB 시스템**: 시각적 개선 및 원거리 공격 메커니즘
- **고급 AI 시스템**: 스마트한 적 행동 패턴
- **보스 저항 시스템**: 강력한 보스들의 상태 이상 저항력

👥 **28개의 고유 직업군 + 직업별 특화 시스템**
- **직업별 고유 기본 공격**: 각 직업마다 완전히 다른 고유 기본 공격
- **랜덤 이름 시스템**: 매번 새로운 캐릭터와 만남
- **캐릭터 해금 시스템**: 조건 달성 시 새 직업 해금
- **원거리/근거리 구분**: ATB 절약 메커니즘으로 전략적 깊이 증가
