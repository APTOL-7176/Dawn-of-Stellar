    ...
    def load_game(self, save_name: str) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            with open(save_path, 'r', encoding='utf-8') as f:
                game_state = json.load(f, object_hook=decode_game_state)
...
class GameStateSerializer:
    ...
    def deserialize_character(char_data: Dict[str, Any]):
        ...
        character.brave_points = char_data.get('brave_points', 400)
        ...
        def deserialize_equipment(equipment_data):
            ...
            try:
                ...
                equipment = Item(
                    ...
                    effects=equipment_data.get('effects', {})
                )
                equipment.durability = equipment_data.get('durability', 100)
                equipment.max_durability = equipment_data.get('max_durability', 100)
                return equipment
            except Exception as e:
